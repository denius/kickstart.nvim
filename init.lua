...
vim.keymap.set('n', '<M-PageUp>',     ':bprevious<cr>', { silent = true }) -- previous buffer
vim.keymap.set('n', '<M-PageDown>',   ':bnext<cr>',     { silent = true }) -- next buffer
...
require('lazy').setup({
  ...
  -- by denis 'NMAC427/guess-indent.nvim', -- Detect tabstop and shiftwidth automatically
